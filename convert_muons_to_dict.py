...
from icecube.phys_services import I3Calculator   # To compare with the residual computer we have already
import numpy as np              
import matplotlib
import pickle
matplotlib.use('Agg') 
...
directory = '/data/p-one/sim/muon/sim0006/daq10'          # Files for events that were triggered
...
save_object(muon_dict, "/data/p-one/dghuman/simulation/MCEq_tables/muon_dict_0006_triggered.pkl")
